...
const ProjectDesktop = ({
  ...
  return (
    <a target='_blank' href={link} rel='noopener noreferrer'>
      <div
        className={`flex relative ${backgroundColor} text-tBlack lg:w-[840px] w-full lg:h-[336px] h-[180px] lg:pr-8 cursor-pointer lg:hover:bg-white group transition-all duration-500`}
      >
